...
* Lets users find nearby specialists with a built‑in map feature
* Provides eye‑health tips, exercises, and safety guidance
...
* Training and optimizing the ML models
* Bridging SHAP outputs from Python into CoreML
* Designing a simple, clear UI that anyone can use
...
[https://youtu.be/izvR91hsc-I](https://youtu.be/izvR91hsc-I)

## Source Code

[https://github.com/RonitBStudent/Final-Submission-CAC](https://github.com/RonitBStudent/Final-Submission-CAC)
